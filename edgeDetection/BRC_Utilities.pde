...
int BRC_port = 10002;
int BRC_WebBodySize = 7619;

String[] BRC_ids = new String[] {"files","Load","threshold","Vertical edges","Horizontal edges","Omni-directional"};
String[] BRC_values = new String[] {"H","0","181","0","0","0"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"NOTE\",\"brc_1\",\"title\"],\n"
+ "[\"DROPDOWN\",\"brc_2\",\"files\"],\n"
+ "[\"BUTTON\",\"brc_3\",\"Load\"],\n"
+ "[\"RANGE\",\"brc_4\",\"threshold\",\"brc_5\"],\n"
+ "[\"BUTTON\",\"brc_6\",\"Vertical edges\"],\n"
+ "[\"BUTTON\",\"brc_7\",\"Horizontal edges\"],\n"
+ "[\"BUTTON\",\"brc_8\",\"Omni-directional\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "    <input type=\"range\" id=\"brc_4\" name=\"brc_4\" min=\"0\" max=\"400\" value=\"181\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_4','brc_5','threshold');\" />  400<br/>\n"
+ "    threshold: <label id=\"brc_5\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "</td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Vertical edges\" onClick=\"SendNameValue('Vertical edges='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Horizontal edges\" onClick=\"SendNameValue('Horizontal edges='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Omni-directional\" onClick=\"SendNameValue('Omni-directional='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td></tr></table>\n"
+ "\n"
