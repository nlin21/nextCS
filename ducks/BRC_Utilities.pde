...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"BUTTON\",\"brc_1\",\"Add a duck\"],\n"
+ "[\"BUTTON\",\"brc_2\",\"Clear the ducks\"],\n"
+ "[\"CHECKBOX\",\"brc_3\",\"Pause the ducks\"],\n"
...
+ "\n"
+ "<table><tr><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Add a duck\" onClick=\"SendNameValue('Add a duck='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Clear the ducks\" onClick=\"SendNameValue('Clear the ducks='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " </td><td><table ><tr><td class=\"auto-style1\">\n"
+ "Pause the ducks:  <input name=\"brc_3\" type=\"checkbox\"  id=\"brc_3\" onclick=\"SendCheckbox('brc_3','Pause the ducks');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td><td><table ><tr><td class=\"auto-style1\">\n"
+ "Lots of ducks:  <input name=\"brc_4\" type=\"checkbox\"  id=\"brc_4\" onclick=\"SendCheckbox('brc_4','Lots of ducks');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
...
+ "    <input type=\"range\" id=\"brc_6\" name=\"brc_6\" min=\"0\" max=\"10\" value=\"5\" step=\"1\"\n"
+ "	oninput=\"ShowRange('brc_6','brc_7','amplitude');\" />  10<br/>\n"
